...
def booking_submit(request):
    if request.method == 'POST':
        try:
            ...
            logger.info("Booking data received: %s", data)
            ...
            logger.info("Booking saved to database: %s", booking.id)  # type: ignore
...
Please follow up with the client as soon as possible.
                ...
                logger.info("Sending email to: %s", settings.CONTACT_EMAIL)
